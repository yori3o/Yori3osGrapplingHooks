...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.translatable("settings.yo_hooks.open_file"), b -> FileOpenUtil.revealConfigFile(new File(Platform.getConfigFolder().resolve("yo_hooks_common.json").toUri()))).bounds(x1, this.height - 90, colWidth, 20).build());
        addRenderableWidget(Button.builder(Component.translatable("settings.yo_hooks.open_file"), b -> FileOpenUtil.revealConfigFile(new File(Platform.getConfigFolder().resolve("yo_hooks_server.json").toUri()))).bounds(x2, this.height - 90, colWidth, 20).build());
