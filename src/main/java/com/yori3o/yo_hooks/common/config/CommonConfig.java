...
public class CommonConfig extends JsonConfigManager<CommonConfig.Values> {
    ...
    public static class Values {
        public int copperHookDurabitility = 42;
        ...
        public int copperHookLength = 10; // 26
    ...
    private static final Path CONFIG_PATH = FabricLoader.getInstance().getConfigDir().resolve("yo_hooks_common.json");
