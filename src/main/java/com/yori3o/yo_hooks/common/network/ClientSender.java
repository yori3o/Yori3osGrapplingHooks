...
public class ClientSender {
    ...
    public static void JumpFromHook(boolean cancelUsing) {
        ...
        NetworkManager.sendToServer(Identifier.fromNamespaceAndPath("yo_hooks", "player_jump"), originalBuf);*/
    ...
    public static void CheckConfig(boolean softHook, float stiffness, float climbSpeed, boolean funnyMode) {
        ...
        NetworkManager.sendToServer(Identifier.fromNamespaceAndPath("yo_hooks", "check_config"), originalBuf); */
    ...
    public static void Climb(boolean up, int agility_level) {
        ...
        NetworkManager.sendToServer(Identifier.fromNamespaceAndPath("yo_hooks", "climb"), originalBuf); */
